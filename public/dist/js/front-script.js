                ...
                while (1) {
                    switch (_context28.prev = _context28.next) {
                        ...
                        case 4:
                            ...
                            _context28.t0 = parseFloat;
                            _context28.t1 = App.web3_1_0.utils;
                            _context28.next = 10;
                            return App.helper.getAddressETHBalance(global_state.account);
                                                    ...
                                                    while (1) {
                                                        switch (_context27.prev = _context27.next) {
                                                            case 0:
                                                                ...
                                                                $('.recipe-popup .extra-recipe-html').html('<div class="input-row padding-top-0 padding-bottom-0"><label for="cancel-contract-reason" class="inline-block">Cancellation reason</label><div class="field inline-block"><select id="cancel-contract-reason"><option>Overdue payments</option><option>Missed regular check-ups</option><option>Inappropriate behaviour</option><option data-open-bonus-field="true">Other</option></select></div></div><div class="camp-for-row"></div><div class="popup-row"><label for="cancel-contract-comments" class="inline-block">Comments:</label><div class="field inline-block"><textarea id="cancel-contract-comments" maxlength="3000" class="pencil-background" placeholder="Please enter"></textarea></div></div>');
    ...
    $('.proof-of-address .verify-address-btn').click(function () {
        if (keystore_file != null) {
            ...
            if ($('.proof-of-address #your-private-key').val().trim() == '' || $('.proof-of-address #your-private-key').val().trim().length > 64) {
                ...
                $('.response-layer').show();
                setTimeout(_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee30() {
                    ...
                    return _regeneratorRuntime.wrap(function _callee30$(_context30) {
                        while (1) {
                            switch (_context30.prev = _context30.next) {
                                ...
                                case 4:
                                    decrypted_pdf_response = _context30.sent;
                                ...
                                case 9:
                                    $.ajax({
                                        ...
                                        success: function () {
                                            var _ref30 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee29(response) {
        ...
        if (keystore_file != null) {
            ...
            if ($('.proof-of-address #your-private-key').val().trim() == '' || $('.proof-of-address #your-private-key').val().trim().length > 64) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        var _ref31 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee31(response) {
                            var user_data;
