        ...
        if ($('body').hasClass('patient-contract-view')) {
            ...
            if ($('.contract-header').hasClass('active')) {
                ...
                function patientDcnBalanceLogic(current_patient_dcn_balance) {
                    ...
                    if(current_patient_dcn_balance > dcn_needed_to_be_payed_to_dentist) {
                        ...
                        //not enough DCN
                        $('.camping-for-popups').append('<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 text-center fs-20 contract-response-message module"><div class="wrapper text-center padding-top-30"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Fund icon" src="/assets/uploads/fund-icon.svg" class="max-width-70"/></figure><h2 class="lato-bold fs-22 padding-top-15 blue-green-color">YOUR CONTRACT</h2><h3 class="fs-22 padding-top-5 lato-bold">Time to fund your account now!</h3><div class="fs-18 fs-xs-16 calibri-light padding-top-15 padding-bottom-25">You should fund your account with DCN equivalent to <span class="calibri-bold blue-green-color">'+(months_passed_for_reward * on_load_exiting_contract[4])+' USD</span> (at the moment: <span class="calibri-bold blue-green-color">'+dcn_needed_to_be_payed_to_dentist+' DCN</span>) before <span class="calibri-bold blue-green-color">'+dateObjToFormattedDate(next_payment_timestamp_date_obj)+'</span>.</div><div><a href="javascript:void(0)" class="white-blue-green-btn min-width-150 scroll-to-buy-section">FUND NOW</a></div></div></div>');
                ...
                function initCheckUpAndRecordTeethCleaningLogic() {
                    $('.camping-for-popups').html('<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 text-center fs-20 contract-response-message module"><div class="wrapper text-center"><figure itemscope="" itemtype="http://schema.org/ImageObject" class="padding-top-20 margin-right-10 inline-block"><img alt="Check inside shield" src="/assets/uploads/check-up.svg" class="max-width-70 width-100"/></figure><figure itemscope="" itemtype="http://schema.org/ImageObject" class="padding-top-20 inline-block"><img alt="Check inside shield" src="/assets/uploads/teeth-cleaning.svg" class="max-width-70 width-100"/></figure><h2 class="lato-bold fs-20 padding-top-15">TIME FOR CHECK-UP & TEETH CLEANING</h2><div class="fs-18 fs-xs-16 calibri-light padding-top-10 padding-bottom-25">Your dentist recommended you to visit them '+$('.patient-contract-single-page-section').attr('data-checkups')+' times per year for a check-up and '+$('.patient-contract-single-page-section').attr('data-teeth-cleanings')+' times per year for a teeth cleaning. Did you have your teeth examined and cleaned already?</div><div><a href="javascript:void(0)" class="white-blue-green-btn min-width-150 record-teeth-cleaning-action">YES, I\'VE BEEN THERE</a></div></div></div>');
                    scrollToPopupsCamper();

                    $('.record-teeth-cleaning-action').click(function() {
                        $('.camping-for-popups').html('<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 text-center fs-20 contract-response-message module"><div class="wrapper text-center"><figure itemscope="" itemtype="http://schema.org/ImageObject" class="padding-top-20"><img alt="Check inside shield" src="/assets/uploads/teeth-cleaning.svg" class="max-width-70"/></figure><h2 class="lato-bold fs-20 padding-top-15">WHEN DID YOU HAVE YOUR CHECK-UP AND TEETH CLEANING?</h2><div class="fs-18 fs-xs-16 calibri-light padding-top-20 padding-bottom-25"><label class="display-block fs-14 lato-semibold">Check-up Date:</label><input type="text" class="custom-input max-width-300 margin-0-auto check-up-datepicker"/></div><div class="fs-18 fs-xs-16 calibri-light padding-top-20 padding-bottom-25"><label class="display-block fs-14 lato-semibold">Teeth Cleaning Date:</label><input type="text" class="custom-input max-width-300 margin-0-auto teeth-cleaning-datepicker"/></div><div><a href="javascript:void(0)" class="white-blue-green-btn min-width-150 record-check-up-submit">SUBMIT</a></div></div></div>');
                        initDatepicker();
                ...
                function patientApprovalAndContractCreationLogic(current_user_dcn_balance, current_user_eth_balance) {
                    if (current_user_dcn_balance < monthly_premium_in_dcn && parseFloat(eth_fee) > current_user_eth_balance) {
                        ...
                        $('.camping-for-popups').append('<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3 text-center fs-20 contract-response-message module"><div class="wrapper text-center padding-top-30"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Fund icon" src="/assets/uploads/fund-icon.svg" class="max-width-70"/></figure><h2 class="lato-bold fs-22 padding-top-15 blue-green-color">YOUR CONTRACT</h2><h3 class="fs-22 padding-top-5 lato-bold">Time to fund your account now!</h3><div class="fs-18 fs-xs-16 calibri-light padding-top-15 padding-bottom-25">You should fund your account with <span class="calibri-bold blue-green-color">'+eth_fee+' ETH</span> before <span class="calibri-bold blue-green-color">'+dateObjToFormattedDate(next_payment_timestamp_date_obj)+'</span>.</div><div><a href="javascript:void(0)" class="white-blue-green-btn min-width-150 scroll-to-buy-section">FUND NOW</a></div></div></div>');
                        initPopupEvents(true);
                    } else {
                        // 2nd step
                        $('.camping-for-popups').html('');
            ...
            if ($('.contract-header').hasClass('awaiting-payment') || $('.contract-header').hasClass('awaiting-approval')) {
                ...
                if (contract_next_payment > now_timestamp) {
                    ...
                    initFlipClockTimer(contract_next_payment + dApp.grace_period - now_timestamp);
                } else {
                    // ready to withdraw
