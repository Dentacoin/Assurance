...
var projectData = {
    ...
    utils: {
        ...
        clearUrlFromGetParam(get_param_name) {
            console.log(get_param_name, 'projectData.utils.clearUrlFromGetParam');
            // remove get param from url
            history.replaceState && history.replaceState(
                null, '', location.pathname + location.search.replace("/[\?&]"+get_param_name+"=[^&]+/", '').replace(/^&/, '?')
            );
        }
    },
    initiators: {
