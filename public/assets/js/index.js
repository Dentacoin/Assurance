                        ...
                        $.ajax({
                            ...
                            success: async function (response) {
                                if(response.success) {
                                    ...
                                    console.log(parseInt(await App.dentacoin_token_methods.allowance(checksumAddress(response.contract_data.dentist), App.assurance_state_address)), 'parseInt(await App.dentacoin_token_methods.allowance(checksumAddress(response.contract_data.dentist), App.assurance_state_address)');
