...
class APIRequestsController extends Controller {
    ...
    public function encryptFile($key, $html) {
        $curl = curl_init();
        $json = '{"public_key":"'.$key.'", "html":"'.str_replace('&quot;',"&apos;" , '<label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label><label class="inline-block">Professional / Company Registration Number:</label>').'"}';
