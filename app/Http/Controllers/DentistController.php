        ...
        if(!empty($contract)) {
            ...
            if(!empty($records)) {
                ...
                if($checkUp != NULL && $teethCleaning != NULL) {
                    $currentCheckUpCount = (new PatientController())->getCheckUpOrTeethCleaning('check-up', $contract->slug, $periodBegin, $periodEnd);
                    $currentTeethCleaningsCount = (new PatientController())->getCheckUpOrTeethCleaning('teeth-cleaning', $contract->slug, $periodBegin, $periodEnd);
