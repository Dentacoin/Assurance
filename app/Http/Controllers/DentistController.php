...
class DentistController extends Controller
{
    ...
    protected function storeAndSubmitTemporallyContract(Request $request) {
        ...
        if ($temporally_contract->id) {
            //send email
            $email_view = view('emails/notify-patient-when-dentist-create-contract', ['patient_fname' => $temporally_contract->patient_fname, 'patient_lname' => $temporally_contract->patient_lname, 'temporally_contract' => $temporally_contract, 'sender' => $this->prepareUserName($sender)]);
