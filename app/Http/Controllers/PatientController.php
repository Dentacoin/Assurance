...
class PatientController extends Controller {
    ...
    protected function getInviteDentistsPopup(Request $request) {
        ...
        $view = view('partials/invite-dentists-popup', ['data' => $postdata, 'sender' => $current_patient, 'receiver' => $receiver, 'title' => 'Invite Your Dentist', 'subject' => 'Invitation to join Dentacoin Assurance', 'body' => $body]);
        $view = $view->render();
        return response()->json(['success' => $view]);
    }
