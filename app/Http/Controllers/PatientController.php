...
class PatientController extends Controller {
    ...
    protected function updateAndSignContract(Request $request) {
        ...
        $encrypted_html_by_patient = (new \App\Http\Controllers\APIRequestsController())->encryptFile($patient_pub_key->public_key, str_replace('&quot;', "\\&quot;", htmlentities((string)$view_body)));
