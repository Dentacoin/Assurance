<div class="one step">
    ...
    <div class="step-fields module padding-top-35 padding-top-xs-20">
        ...
        <div class="single-row flex-row fs-0">
            ...
            @else
                <input type="text" data-type="address" id="dcn_address" name="address" maxlength="42" class="right-field break-word calibri-regular fs-18 dark-color inline-block pencil-background"/>
            @endif
        </div>
