        ...
        <section class="container withdraw-section padding-top-30 padding-bottom-30">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <div class="fs-20">Your money is waiting for you.</div>
                    <div class="padding-bottom-20 fs-20">Withdraw the Dentacoin tokens collected by <span class="calibri-bold">{{$patient->name}}</span>.</div>
                    <div>
