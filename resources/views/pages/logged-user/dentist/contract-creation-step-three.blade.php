<div class="three step">
    ...
    <div class="step-fields module padding-top-35">
        ...
        <div class="single-row flex-row fs-0">
            ...
            <input type="number" name="monthly-premium" maxlength="20" placeholder="The value is in USD" class="right-field calibri-regular fs-18 dark-color inline-block pencil-background" step="0.01" @if(!empty($renew_contract)) value="{{$renew_contract->monthly_premium}}" @endif/>
        </div>
        @if(!empty($renew_contract))
