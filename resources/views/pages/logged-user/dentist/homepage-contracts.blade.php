                    ...
                    <div class="col-xs-12 padding-bottom-50">
                        ...
                        @if(sizeof($active_contracts) > 6)
                            <div class="padding-top-10 text-right">
                                <a href="https://account.dentacoin.com/assurance?platform=assurance" class="black-light-gray-btn margin-right-25">See all</a>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            @if(sizeof($pending_contracts) > 3)
                                <div class="padding-top-10">
                                    <a href="https://account.dentacoin.com/assurance?status=pending&platform=assurance" class="black-light-gray-btn margin-left-10">See all</a>
                                </div>
                            @endif
                        </div>
                    @elseif(sizeof($pending_contracts) == 0 && sizeof($cancelled_contracts) != 0)
                        ...
                        <div class="col-xs-12">
                            ...
                            @if(sizeof($cancelled_contracts) > 3)
                                <div class="padding-top-10 text-right">
                                    <a href="https://account.dentacoin.com/assurance?status=cancelled&platform=assurance" class="black-light-gray-btn margin-right-10">See all</a>
                                </div>
                            @endif
                        </div>
                    @elseif(sizeof($pending_contracts) != 0 && sizeof($cancelled_contracts) != 0)
