...
@section('content')
    ...
    @endif
    <section class="padding-top-100 padding-top-xs-30 padding-top-sm-50 single-contract-view-section awaiting-payment" data-contract="{{$contract->slug}}" data-created-at="{{strtotime($contract->contract_active_at)}}" data-date-start-contract="{{$contract_active_at}}" data-dentist-address="{{$contract->dentist_address}}">
