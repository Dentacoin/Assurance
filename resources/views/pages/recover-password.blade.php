        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <form method="POST" id="recover-password" class="padding-top-80 padding-bottom-80" action="{{route('password-recover-submit')}}">
                        ...
                        <div class="padding-bottom-45"><input type="password" name="password" maxlength="100" class="custom-input max-width-400" placeholder="Password" required/></div>
                        <div>
