                    ...
                    <span class="container display-block">
                        <span class="row display-block">
                            <span class="col-xs-12 col-sm-10 col-sm-offset-1 display-block column padding-right-30">
                                <span class="lato-black fs-20 padding-right-10 blue-green-color">01</span>What is Dentacoin (DCN)?
                            </span>
                        </span>
                    </span>
                </a>
            ...
            <li class="margin-bottom-10">
                <a href="javascript:void(0);" class="fs-20 fs-xs-18 padding-top-20 padding-bottom-20 question block-with-full-width">
                    <span class="container display-block">
                        <span class="row display-block">
                            <span class="col-xs-12 col-sm-10 col-sm-offset-1 display-block column padding-right-30">
                                <span class="lato-black fs-20 padding-right-10 blue-green-color">02</span>What is a wallet and why do I need it?
                            </span>
                        </span>
                    </span>
                </a>
            ...
            <li class="margin-bottom-10">
                <a href="javascript:void(0);" class="fs-20 fs-xs-18 padding-top-20 padding-bottom-20 question block-with-full-width">
                    <span class="container display-block">
                        <span class="row display-block">
                            <span class="col-xs-12 col-sm-10 col-sm-offset-1 display-block column padding-right-30">
                                <span class="lato-black fs-20 padding-right-10 blue-green-color">03</span>How can I create a Dentacoin wallet?
                            </span>
                        </span>
                    </span>
                </a>
                ...
                <div class="fs-18 fs-xs-16 calibri-light padding-bottom-30 padding-top-20 question-content container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                            ...
                            <br><br>
                            <a href="https://www.youtube.com/watch?v=SR5gbFLT8a0" target="_blank" class="white-blue-green-btn">WATCH OUR VIDEO TUTORIAL</a>
                        </div>
                    </div>
                </div>
            </li>
            <li class="margin-bottom-10">
                <a href="javascript:void(0);" class="fs-20 fs-xs-18 padding-top-20 padding-bottom-20 question block-with-full-width">
                    <span class="container display-block">
                        <span class="row display-block">
                            <span class="col-xs-12 col-sm-10 col-sm-offset-1 display-block column padding-right-30">
                                <span class="lato-black fs-20 padding-right-10 blue-green-color">05</span>Which third-party wallets can I use for storing Dentacoin (DCN)?
                            </span>
                        </span>
                    </span>
                </a>
