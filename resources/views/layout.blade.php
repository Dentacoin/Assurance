...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.0.22">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.0.22">
    <script>
...
<script src="/assets/js/address.js{{--?v=1.0.22--}}"></script>
