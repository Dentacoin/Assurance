...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.0.37">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.0.37">
...
<script src="/assets/js/address.js?v=1.0.37"></script>
<script src="/assets/js/index-bundled.js?v=1.0.37"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCaVeHq_LOhQndssbmw-aDnlMwUG73yCdk&libraries=places&language=en"></script>

{{--Load social logging scripts only if user is not logged--}}
@if(!(new \App\Http\Controllers\UserController())->checkSession())
    <script src="//dentacoin.com/assets/libs/civic-login/civic.js?v=1.0.37"></script>
    <script src="//dentacoin.com/assets/libs/facebook-login/facebook.js?v=1.0.37"></script>
@endif
