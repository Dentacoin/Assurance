<div class="camping-for-validation module">
    <div class="single-row proof-of-address no-background fs-0" data-id="{{session('logged_user')['id']}}">
        ...
        <div class="padding-left-15 padding-right-15 padding-top-10 padding-bottom-10 text-center calibri-bold fs-20 inline-block display-block-xs">or</div>
