...
<div class="text-center execute-transaction padding-top-20">
    @if(!empty($cancel_with_blockchain_transaction) && $cancel_with_blockchain_transaction == true)
    ...
    @endif
    <a href="javascript:void(0)" class="white-blue-green-btn min-width-250 margin-bottom-10 width-xs-100 max-width-400">{{$btn_label}}</a>
</div>